...
var layout = {
	...
	display: function (success)
	{
		...
		if (gq.quran.isSelected('quran-tajweed'))
		{
			...
			if (!$.browser.mozilla)
				this.message('error', 'Tajweed fonts best displayed in <a href="https://FireFox.com">FireFox</a> browser.');
		}
	...
	bindExtra: function ()
	{
		...
		// place holder crossBrowser fix by hagenBurger - https://www.hagenburger.net/BLOG/HTML5-Input-Placeholder-Fix-With-jQuery.html
